...
<head>
    ...
    <link rel="stylesheet" href="styleFORGOTPASSWORD2.css">
            ...
            <div class="form-wrapper">
                ...
                <div class="form-content">
                    <form action="be_validate.php" method="post">
                        ...
                        <div class="form-input">
                            <span>OTP</span>
                            <input type="email" name="" id="otp">
                            <label for="otp">Wrong OTP entered !</label>
                        </div>
                        <?php
                        ...
                        <div class="link-area">
                            <span><a href="" style="color: blue;">Resend OTP</a></span>
                        </div>
