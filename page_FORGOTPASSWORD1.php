...
<head>
    ...
    <link rel="stylesheet" href="styleFORGOTPASSWORD1.css">
        ...
        <section class="left-content">
            <div class="content-wrapper">
                ...
                <div class="direction-wrapper">
                    ...
                    <span>Not yet registered? <a href="" style="color: blue;">Register Now</a></span>
                </div>
            </div>
        </section>
        ...
        <section class="right-content">
            ...
            <div class="form-wrapper">
                ...
                <div class="form-subheading">
                    <span>Please provide the email address you used when you signed up for your account.</span>
                </div>
                <div class="form-content">
                    <form action="be_validate.php" method="post">
                        ...
                        <div class="button-area">
                            ...
                            <button type="button" onclick="openForm(submitForm)" id="submit">Send OTP</button>
                        </div>
